...
client.connect((err) => {
  const collection = client.db("bikeService").collection("orders");
  const serviceCollection = client.db("bikeService").collection("service");
  const reviewCollection = client.db("bikeService").collection("review");
  const adminCollection = client.db("bikeService").collection("admin");
  // console.log("db connection success");



  //post method for get admin data
  ...
  app.post("/review", (req, res) => {
    ...
    // };
    reviewCollection
      .insertOne({ name, description, designation, newFile })
      .then((result) => {
        // console.log(result);
        res.send(result);
      });
